                    ...
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="contact.php" class="dropdown-item active">Kontak</a>
    ...
    <div class="container-fluid contact py-5">
        <div class="container py-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                ...
                <p class="mb-0">Berikut ini merupakan kontak Rentalku yang dapat Anda hubungi</a>.</p>
            </div>
            <div class="row g-5">
                    ...
                    <div class="row g-5">
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="contact-add-item p-4">
                                ...
                                <div>
                                    <h4>Alamat</h4>
                                    <p class="mb-0">Jalan BSD Grand Boulevard, No 345, Tangerang Selatan</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-secondary p-5 rounded">
                        <h4 class="text-primary mb-4">Kirim Pesanmu</h4>
                        <form>
                            <div class="row g-4">
                                ...
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        ...
                                        <label for="project">Domisili</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                    ...
                    <div class="p-5 bg-light rounded">
                        <div class="bg-white rounded p-4 mb-0">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <p class="mb-0 text-dark me-2">Alamat:</p><i class="fas fa-map-marker-alt text-primary me-2"></i>
                                <p class="mb-0">Jalan BSD Grand Boulevard, No 345, Tangerang Selatan</p>
                            </div>
                            <div class="d-flex align-items-center">
                                <p class="mb-0 text-dark me-2">Telepon:</p><i class="fa fa-phone-alt text-primary me-2"></i>
                                <p class="mb-0">(+012) 3456 7890</p>
                            </div>
                        </div>
                    </div>
